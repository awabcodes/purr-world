...
export class ImageService {
  ...
  list(req?: {
    ...
    return this.http.get<Image[]>(this.resourceUrl + '/search', {
      params: options,
      observe: 'response',
    });
  }
  ...
  listUploaded(req?: {
    ...
    const options = createRequestOption(req);
    return this.http.get<Image[]>(this.resourceUrl + '/upload', {
      params: options,
      observe: 'response',
    });
  }
  ...
  upload(image: {
    ...
    return this.http.post<any[]>(this.resourceUrl + '/upload', image, {
      observe: 'response',
    });
  }
  ...
  analysis(id: string): Observable<HttpResponse<ImageAnalysis>> {
    return this.http.get(`${this.resourceUrl}/${id}/analysis`, {
      observe: 'response',
    });
  }
}
